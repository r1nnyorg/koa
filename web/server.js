...
app.context.database = new pg.Pool({user:'root', database:'defaultdb', host:'cockroach', port:26257, ssl:{ca:await fs.readFile('ca.crt'), key:await fs.readFile('client.root.key'), cert:await fs.readFile('client.root.crt')}}) 
